...
export default function modalHandler(e) {
  ...
  <header>
    <h2>${header}</h2>
    <img src="./images/close_black.svg" alt="close icon" id="closeImg"/>
  </header>
  ...
  <div class="action-btn">
    <button class="project-btn" type="button">
      <a href=${link1} target="_blank">See live <img src="./images/live.svg" /></a>
    </button>
    <button class="project-btn" type="button">
      <a href=${link2} target="_blank">See Source <img src="./images/git.svg" /></a>
    </button>
    </div>
    </div>
    </div>
